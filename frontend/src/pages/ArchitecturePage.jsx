...
export const ArchitecturePage = () => {
  return (
    <div className="relative space-y-12 py-6 overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto space-y-12">
        ...
        <SectionHeader
          ...
          actions={
            <Link to="/dashboard">
              <Button variant="primary" size="sm" className="gap-1.5 min-h-[38px]">
        ...
        <Card title="System Flow & Data Pipeline" subtitle="From driver radio audio to tactical pit recommendations">
          <div className="p-4 sm:p-6 rounded-xl bg-zinc-50/70 dark:bg-zinc-950/60 border border-zinc-200/80 dark:border-zinc-800 space-y-6 font-mono text-xs">
        ...
        <Card title="Why the Architecture is Modular & Hot-Swappable" subtitle="Design decisions for production Formula 1 deployment">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
            <div className="space-y-1.5 p-3.5 rounded-lg border border-zinc-200/80 dark:border-zinc-800 bg-zinc-50/40 dark:bg-zinc-900/30">
              ...
              <p className="text-[11px] text-zinc-500 leading-relaxed">
                Models can be switched via environment variables (<code>GROQ_STT_MODEL</code>, <code>HF_EMOTION_MODEL</code>) without altering routing or business logic.
              </p>
            </div>
            ...
            <div className="space-y-1.5 p-3.5 rounded-lg border border-zinc-200/80 dark:border-zinc-800 bg-zinc-50/40 dark:bg-zinc-900/30">
              ...
              <p className="text-[11px] text-zinc-500 leading-relaxed">
                If external API rate limits or network latency spikes occur, the backend automatically transitions to domain-tuned acoustic heuristics.
              </p>
            </div>
